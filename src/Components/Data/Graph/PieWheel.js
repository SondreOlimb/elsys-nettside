...
//Dette elementer samenligner aktiviteten i alle nodene i et kakediagram.
...
function PieWheel({ myData = [], timeInterval, timeFrom, timeTo }) {
  ...
  //Kode henter fra dokumentasjonen til Highcharts og tilpasset
  const options = {
    chart: {
